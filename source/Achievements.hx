...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Uma Esquisita Sexta á Noite",	"Jogue Friday... Night.",						'friday_night_play',	 true],
		["Ela também me chama de papai",		"Jogue a Week 1 no Hard Sem Errar Nenhuma Nota",				'week1_nomiss',			false],
		["Não há mais truques",				"Jogue a Week a 2 no Hard Sem Errar Nenhuma Nota",				'week2_nomiss',			false],
		["Me chame de assassino",			"Jogue Week a 3 no Hard Sem Errar Nenhuma Nota",				'week3_nomiss',			false],
		["Dama Assassina",					"Jogue a Week 4 no Hard Sem Errar Nenhuma Nota",				'week4_nomiss',			false],
		["sem saudades do Natal",			"Jogue a Week 5 no Hard Sem Errar Nenhuma Nota",				'week5_nomiss',			false],
		["Highscore!!",					"Jogue a Week 6 no Hard Sem Errar Nenhuma Nota",				'week6_nomiss',			false],
		["Você vai pagar por isso...",		"Jogue a Week 7 no Hard Sem Errar Nenhuma Nota",				'week7_nomiss',			 true],
		["Que Funkin' Desastre!",	"Complete uma música com uma classificação menor que 20%.",	'ur_bad',				false],
		["Perfeccionista",				"Complete uma música com uma classificação de 100%.",			'ur_good',				false],
		["Entusiasta de atropelamentos",			"Assista os capangas morrerem mais de 100 vezes.",			'roadkill_enthusiast',	false],
		["Exagerando muito...?",		"Segure uma nota por 10 segundos.",					'oversinging',			false],
		["Hiperativo",					"Termine uma música sem ficar ocioso.",				'hype',					false],
		["Apenas nós dois",			"Termine uma música pressionando apenas duas teclas.",			'two_keys',				false],
		["Torradeira Gamer",				"Já tentou rodar o jogo em uma torradeira?",		'toastie',				false],
		["Debugger",					"Vença o estágio \"Test\" do Chart Editor.",	'debugger',				 true]
	];
